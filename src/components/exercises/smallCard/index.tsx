...
export const ExerciseSmallCard:React.FC<ExerciseSmallCard> = ({ exerciseName, exerciseType, category = 'technical' }) => {

    return (
        <Link to="/exercise">
            <article className="flex flex-col align-center justify-center exercise-small-card">
