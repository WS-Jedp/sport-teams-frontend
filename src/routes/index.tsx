...
import { UserExerciseDetail } from '../pages/userExerciseDetail'
                ...
                
                {
                    isAuth && (
                        <>
                            ...
                            <Route exact path="/user/:id/exercises" component={UserExercises}  />
                            <Route exact path="/user/:id/exercise/:exerciseId"  component={UserExerciseDetail}  />
